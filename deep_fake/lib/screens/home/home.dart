...
class _HomePageState extends State<HomePage> {
  ...
  void _submit() async {
    ...
    try {
      final videoUploadService = context.read<VideoUploadService>();
      await videoUploadService.uploadVideo(_filePath, _analysisType);

      if (videoUploadService.report != null) {
        showDialog(
          context: context,
          builder: (_) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text('Report: ${videoUploadService.report}'),
                Text(
                    'Probability Score: ${videoUploadService.probabilityScore}'),
              ],
            ),
            actions: [
              TextButton(
